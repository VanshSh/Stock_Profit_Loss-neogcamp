...
function lossOrProfit(cost, qty, selling) {
  ...
  if (sellingValue <= costValue / 2) {
    ...
    lossOutput.innerHTML = ` <h2> Loss: ${maxloss * qtyValue} </h2>
  ...
  if (costValue > sellingValue) {
    ...
    formSection.style.display = 'none'
    lossOutput.style.display = 'block'
    lossOutput.innerHTML = `<h1>Loss <img src="https://img.icons8.com/ios-filled/50/fa314a/bearish.png" /></h1> <h2> Loss: ${
      loss * qtyValue
    } </h2>
  ...
  // Profit
    ...
    profitOutput.innerHTML = ` <h1>Profit <img src="https://img.icons8.com/ios-filled/50/26e07f/bullish.png" /></h1> <h2> Profit: ${
      profit * qtyValue
    } </h2>
